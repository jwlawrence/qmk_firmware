...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
   * |  FN  | ADJ  |  RGB | Ctrl | Alt  |  GUI | Alt  |  | Enter| Space|  FN  | Left | Down |  Up  |Right |
   * |------+------+------+------+------+------+------|  |------+------+------+------+------+------+------'
   *                                    |  GUI | Alt  |  | Enter| Space|
   *                                    `-------------'  `-------------'
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_GRV,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G, KC_LPRN,     KC_RPRN, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_LCBR,     KC_RCBR, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    FN,       ADJ,     RGB_TOG, KC_LCTL, KC_LALT, KC_LGUI, KC_LALT,  KC_ENT,  KC_SPC  ,  FN,    KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,  \
                                                  KC_LGUI, KC_LALT,  KC_ENT,  KC_SPC \
  ),
